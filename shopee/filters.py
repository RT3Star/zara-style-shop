...
class ProductFilter:
    ...
    def get_queryset(self):
        """Повертає фільтрований queryset з оптимізацією"""
        # Оптимізація запитів
    ...
    def get_price_range(self):
        """Отримує мінімальну та максимальну ціну в категорії"""
    ...
    def get_available_filters(self):
        """Отримує доступні значення для фільтрів"""
        available_filters = {
            "categories": list(
...
# Проста функція для швидкої фільтрації
def filter_products(request, queryset):
    """Зручна функція для фільтрації товарів"""
